...
状态：0.1.2 Windows 验证版已实现，待完整应用验收。更新日期：2026-09-17。
...
类型检查、20 项必要自动化测试、前后端构建通过。真实 Codex CLI 0.146.0 已与隔离的本地 Responses 夹具完成模型和环境凭据继承、发送、流式回复、补充、中断测试；通过运行中的中继读取到了官方桌面当前会话。
